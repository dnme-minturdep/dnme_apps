...
+ En junio 2022, se registraron los mayores valores de viajeros y pernoctaciones de **residentes** para todos los meses de junio desde que se realiza el relevamiento.
...
localidades_sin_datos <- c("La Falda","Mar Chiquita","Villa General Belgrano","Formosa","Neuquén")
localidades_insuficiencia <- c("Puerto Iguazú", "Las Grutas","Rio Gallegos","Viedma")
