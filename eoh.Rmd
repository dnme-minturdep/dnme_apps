...
grafico2 <- datos_grafico2 %>% 
  ...
  theme(
    ...
    plot.subtitle  = element_markdown(family = familia_fuente, size = 12, hjust = 1.5),
    plot.caption = element_markdown(size = 8, family = familia_fuente),
...
localidades_sin_datos <- c("Mar del Plata", "Pinamar", "Villa Gesell", "CABA",
                               "La Falda","Miramar","Mina Clavero","Río Cuarto",
                               "Carlos Paz","Villa General Belgrano","La Rioja",
                               "Merlo","San Luis","Gualeguaychú","Puerto Iguazú",
                               "Resistencia","Cafayate","Santiago del Estero","Viedma",
                               "Termas de Río Hondo","Las Grutas")
localidades_insuficiencia <- c("Puerto Iguazú", "Rafaela","Calafate")
