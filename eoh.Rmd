...
+ En abril 2022, se registraron los mayores valores de viajeros y pernoctes de **residentes** para todos los meses de abril desde que se realiza el relevamiento.
...
localidades_sin_datos <- c("Villa Gesell", "Formosa","Resistencia")
localidades_insuficiencia <- c("Puerto Iguazú", "Calafate","Viedma")
