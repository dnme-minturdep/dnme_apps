...
+ En la totalidad del año 2022, se registraron los mayores valores de **pernoctaciones de residentes** desde que se realiza el relevamiento.
...
localidades_sin_datos <- c("Puerto Iguazú","Rafaela")
localidades_insuficiencia <- c("Las Grutas","Santa Rosa","Viedma")
