...
+ En septiembre 2022, se registraron los mayores valores de pernoctaciones de **residentes** para todos los meses de septiembre desde que se realiza el relevamiento.
...
localidades_sin_datos <- c("Puerto Iguazú","Rafaela","Calafate")
localidades_insuficiencia <- c("Puerto Iguazú", "Calafate","Neuquén")
