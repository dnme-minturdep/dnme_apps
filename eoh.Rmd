...
localidades_sin_datos <- c("Mar del Plata", "Tandil", "CABA", "San Luis", "Gualeguaychú", "Resistencia", "Calafate", "Las Grutas", "Rio Gallegos")
localidades_insuficiencia <- c("Malargue-Las Leñas","Puerto Iguazú", "Rafaela", "Puerto Madryn", "Viedma")
