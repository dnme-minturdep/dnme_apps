...
+ En agosto 2022, se registraron los mayores valores de pernoctaciones de **residentes** para todos los meses de agosto desde que se realiza el relevamiento.
...
localidades_sin_datos <- c("Formosa","Calafate","Puerto Iguazú","Ushuaia")
