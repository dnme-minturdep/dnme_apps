...
+ En mayo 2022, se registraron los mayores valores de pernoctaciones de **residentes** para todos los meses de mayo desde que se realiza el relevamiento.
...
localidades_sin_datos <- c("Formosa")
localidades_insuficiencia <- c("Puerto Iguazú", "Calafate")
