...
+ En febrero 2022, se registraron los mayores valores de viajeros y pernoctes de residentes para todos los meses de febrero desde que se realiza el relevamiento (en enero 2022 se había registrado el récord de pernoctes de residentes, no así de viajeros).
...
localidades_sin_datos <- c("Formosa", "Puerto Iguazú")
localidades_insuficiencia <- c("Posadas", "Puerto Iguazú", "Calafate")
