...
tablafinal_ficha <- tabla1_A %>% select(indice_tiempo, origen_viajeros, pernoctes, var_ia_pernoctes,
  ...
  mutate(pernoctes = pernoctes/1000000,
         viajeros = viajeros/1000000) %>% filter(indice_tiempo=="Ene 23") #Sacar este filtro para febrero
```
...
localidades_sin_datos <- c("Puerto Iguazú","Posadas","Rafaela")
localidades_insuficiencia <- c("Puerto Iguazú","Posadas","Valle de Uco","Santa Rosa")
