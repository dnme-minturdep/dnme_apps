...
localidades_sin_datos <- c("Pinamar", "Tandil","Villa Gesell","CABA","Resistencia","Calafate","Viedma")
localidades_insuficiencia <- c("Puerto Iguazú", "Rafaela")
