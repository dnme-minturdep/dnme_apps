...
grafico2 <- datos_grafico2 %>% 
  ...
  theme(
    ...
    plot.subtitle  = element_markdown(family = familia_fuente, size = 12, hjust = 1.8),
    plot.caption = element_markdown(size = 8, family = familia_fuente),
...
grafico3 <- datos_grafico3 %>% ggplot() +
  ...
  theme(
    ...
    plot.subtitle  = element_markdown(family = familia_fuente, size = 12, hjust = -0.1),
    plot.caption = element_markdown(size = 8, family = familia_fuente),
    axis.text.x = element_blank(),
    axis.text.y = element_text(size = 12, colour = "black", face = "bold"),
    panel.grid.major = element_blank(),         
...
localidades_sin_datos <- c("Mar del Plata", "Pinamar", "Villa Gesell", "CABA",
                               "La Falda","Mar Chiquita","Mina Clavero",
                               "Carlos Paz","Villa General Belgrano",
                               "San Luis","Gualeguaychú","Resistencia",
                           "Termas de Río Hondo", "El Calafate","Las Grutas","Viedma")
localidades_insuficiencia <- c("Puerto Iguazú", "Posadas")
