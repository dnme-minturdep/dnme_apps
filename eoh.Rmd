...
localidades_sin_datos <- c("Puerto Iguazú","Posadas","El Calafate","Santa Rosa")
localidades_insuficiencia <- c("Corrientes","Puerto Iguazú","Las Grutas","Neuquén")
