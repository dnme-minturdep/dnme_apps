...
+ En noviembre 2022, se registraron los mayores valores de **pernoctaciones de residentes** para todos los meses de noviembre desde que se realiza el relevamiento.
...
localidades_sin_datos <- c("Malargue-Las Leñas","Puerto Iguazú","Rafaela","Puerto Madryn","Viedma")
localidades_insuficiencia <- c("Calafate","Rio Gallegos")
