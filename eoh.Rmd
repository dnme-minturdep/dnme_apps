...
description: "Resumen de los últimos datos de la Encuesta de Ocupación Hotelera (EOH), operativo conjunto entre el Instituto Nacional de Estadística y Censos (INDEC) y la Subsecretaría de Turismo, que releva información de los establecimientos hoteleros y parahoteleros de 52 destinos turísticos del país."
...
localidades_sin_datos <- c("Pinamar","Tandil","Calafate")#Localidades años anterior
