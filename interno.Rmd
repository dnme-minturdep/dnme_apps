...
grafico <- data_grafico %>%
  ...
  geom_segment(data=filter(data_grafico,indicador=="variacion_tur"),aes(x = "2021-1", xend ="2021-3",y = 35, yend = 50), size = 1, color = "white", alpha = 1)+# Acá agrego "sensación" de corte
  geom_segment(data=filter(data_grafico,indicador=="variacion_tur"),aes(x = "2021-2", xend ="2021-4",y = 35, yend = 50), size = 1, color = "white", alpha = 1)+# Acá agrego "sensación" de corte
