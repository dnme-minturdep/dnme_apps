...
tabla <- pasajeros_totales_cabotaje_acumulado %>% 
  ...
  summarise(anio_2017 = sum(anio_2017, na.rm = T),
            ...
            anio_2025 = sum(anio_2025,na.rm = T),
