...
[^1]: Por su parte, el **mercado internacional** resgistró un **`r int_var_2019_vuelos` de vuelos, un `r int_var_2019_pasajeros` de pasajeros y un `r int_var_2019_asientos` de asientos en respecto al mismo período**. Si bien dichos valores se encuentran debajo de los niveles prepandémicos, los mismos no distan de los indicadores a nivel regional. A su vez, se espera que en los próximos meses se reactiven viejos corredores detenidos durante la pandemia, se sumen nuevas frecuencias a las rutas existentes, y entre nuevos actores y rutas al mercado - Ver Documento de Trabajo N°11.
