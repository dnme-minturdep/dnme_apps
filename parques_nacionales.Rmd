...
# PARQUES NACIONALES `r toupper(glue("{mes} {anio}"))`

<br> 
```{r}
#Importo datos
parques_nacionales <- read_excel("/srv/DataDNMYE/parques_nacionales/Pivot_PN_20210916.xlsx",
...
#tabla_1 <- 
  ...
  fmt_missing(columns = 1:8,
              missing_text = "///") %>% 
  tab_source_note(glue("///: Dato que no corresponde mostrar debido a la naturaleza de las cosas. En junio 2020, el número de visitas a Parques Nacionales fue considerado nulo debido a la emergencia sanitaria; por ello no es posible realizar la comparación i.a. de {mes} 2021."))
...
#tabla2 <- 
  ...
  fmt_percent(columns = c(3,5,7,9,10), decimals = 1, dec_mark = ",") %>% 
  cols_align(
    align = "center",
...
# htmltools::save_html(html = tabla2, file = "tabla2.html")
# webshot::webshot("tabla2.html", file="out.png", delay=3, vwidth = 900, vheight = 300)
```
