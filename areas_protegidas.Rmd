...
parques_sin_dato <- c("pizarro", "ansenuza", "formosa", "chaco", "campos del tuyu", "monte leon", "isla pingüino", "traslasierra")
...
#tabla2 <- 
  ...
  tab_source_note("Nota: No se recibió información de visitas de los PN Ansenuza, Monte León, Isla Pingüino, Chaco, Campos del Tuyú, Traslasierra, RN Formosa y la RN Pizarro.")
