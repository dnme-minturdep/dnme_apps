...
mes <- "septiembre"
anio <- "2024"
parques_sin_dato <- c("pizarro", "los cardones", "ansenuza", "traslasierra", "isla pingüino")
...
#tabla2 <- 
  ...
  tab_source_note("Nota: No se recibió información de visitas de los PN Los Cardones, Formosa, Islas de Santa Fe, Ansenuza, Traslasierra yla RN Pizarro.")
