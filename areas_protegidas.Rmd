...
parques_sin_dato <- c("pizarro","predelta", "laguna blanca")
...
#tabla2 <- 
  ...
  tab_source_note("Nota: No se recibió información de visitas de los PN Pre Delta, Laguna Blanca y la RN Pizarro.")
