...
parques_sin_dato <- c("pizarro","los cardones", "formosa", "rio pilcomayo")
...
#tabla2 <- 
  ...
  tab_source_note("Nota: No se recibió información de visitas de los PN Los Cardones, Formosa,Río Pilcomayo y la RN Pizarro.")
