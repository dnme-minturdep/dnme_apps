...
parques_sin_dato <- c("pizarro", "ansenuza", "isla pingüino", "campos del tuyu")
...
#tabla2 <- 
  ...
  tab_source_note("Nota: No se recibió información de visitas de los PN Ansenuza, Isla Pingüino, Campos del Tuyú y la RN Pizarro. En el PN Los Alerces, la variación interanual se vio impactada debido a que en el 2024 se recibio información de visitas solo de las portadas Centro y PN Los Alerces - Intendencia, mientras que en el 2025 se registraron por las portadas Norte, Centro y Sur. En el PN Río Pilcomayo, la variación interanual puede verse impactada debido a que en el 2024 la portada Laguna Blanca se mantuvo cerrada a la visita por daños en la infraestructura) ")
