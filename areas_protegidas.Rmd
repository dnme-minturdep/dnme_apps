...
parques_sin_dato <- c("pizarro","predelta", "laguna blanca", "formosa", "rio pilcomayo", "colonia benitez")
...
#tabla2 <- 
  ...
  tab_source_note(
    source_note = md(
      "**Fuente**: Dirección Nacional de Mercados y Estadística, Subsecretaría de Turismo en base a la informacion suministrada por la Dirección Nacional de Uso Público, APN")
  ) %>%
  #   tab_source_note(
  #   source_note = md(
  ...
  tab_source_note(glue("///: Dato que no corresponde mostrar debido a la naturaleza de las cosas.")) %>% 
    tab_source_note("El PN Perito Moreno se cierra a la visita desde fines de abril a principios de octubre.") %>% 
  tab_source_note("Nota: No se recibió información de visitas de los PN Pre Delta, Laguna Blanca, Formosa, Colonia Benítez, la RN Pizarro.")
