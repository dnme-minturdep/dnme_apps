...
### (Publicado en octubre 2021 con datos actualizados a junio 2021)
...
grafico_empleo_cat_rct <- ggplot(data_grafico_empleo_cat_rct,aes(x=reorder(cat.rct,puestos),y=puestos))+
  ...
  labs(x="",y="",title= "Empleo en Ramas Características del Turismo",
       subtitle = paste0("Miles de puestos de trabajo.","junio 2021 <span style='color:#f7a1c9'>Variación i.a.</span> y <span style='color:#F7941E'>Var. mismo período 2019</span>"), caption="**Fuente:** DNMyE en base a MDP")
...
grafico_empresas_cat_rct <- ggplot(data_grafico_empresas_cat_rct,aes(x=reorder(cat.rct,empresas),y=empresas))+
  ...
  labs(x="",y="",title= "Empleadores en Ramas Características del Turismo",
       subtitle = paste0("Miles de empresas.","junio 2021 <span style='color:#f7a1c9'>Variación i.a.</span> y <span style='color:#F7941E'>Var. mismo período 2019</span>"), caption="**Fuente:** DNMyE en base a MDP")
