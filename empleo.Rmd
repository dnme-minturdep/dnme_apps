...
empleo <- read.csv("/srv/DataDNMYE/empleo/puestos_total_empresas_mensual_por_clae6_06122021.csv")
...
empleadores <- read.csv("/srv/DataDNMYE/empleo/empleadoras_total_empresas_por_clae6_06122021.csv")

#ATENCIÓN: EN ESTA OPORTUNIDAD LOS DATOS DE EMPRESAS LLEGAN HASTA JULIO 2021, NO AGOSTO
fecha_empresas <- "2021-07-01"

puestos.genero <- read.csv("/srv/DataDNMYE/empleo/share_mujer_total_empresas_mensual_por_clae6_06122021.csv")
################################################################################
...
grafico_empleo_cat_rct <- ggplot(data_grafico_empleo_cat_rct,aes(x=reorder(cat.rct,puestos),y=puestos))+
  ...
  labs(x="",y="",title= "Empleo en Ramas Características del Turismo",
       subtitle = paste0("Miles de puestos de trabajo.","agosto 2021 <span style='color:#f7a1c9'>Variación i.a.</span> y <span style='color:#F7941E'>Var. mismo período 2019</span>"), caption="**Fuente:** DNMyE en base a MDP")
