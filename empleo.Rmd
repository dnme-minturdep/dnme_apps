...
### (Publicado en diciembre 2021 con datos actualizados a agosto 2021)
...
grafico_empresas_cat_rct <- ggplot(data_grafico_empresas_cat_rct,aes(x=reorder(cat.rct,empresas),y=empresas))+
  ...
  labs(x="",y="",title= "Empleadores en Ramas Características del Turismo",
       subtitle = paste0("Miles de empresas."," format(as.Date(fecha_empresas),'%B') {format(as.Date(fecha_empresas),'%Y')} <span style='color:#f7a1c9'>Variación i.a.</span> y <span style='color:#F7941E'>Var. mismo período 2019</span>"), caption="**Fuente:** DNMyE en base a MDP")
