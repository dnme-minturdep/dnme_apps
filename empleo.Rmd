...
### (Publicado en `r format(Sys.Date(),'%B')` `r format(Sys.Date(),'%Y')` con datos actualizados a septiembre 2022)
...
grafico_empleo_series <- ggplot(indice.empleo,aes(x=as.Date(fecha),y=indice,color=rct,group=rct,
  ...
  scale_x_date(breaks = seq.Date(as.Date(min(indice.empleo$fecha))+months(2),as.Date(max(indice.empleo$fecha)),by="6 months"),
